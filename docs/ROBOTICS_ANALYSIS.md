...
1.  **Fast Perception & Semantic Interruption Conflict Resolution:** CVS-3.0's sub-cognitive VAD and semantic segmenter resolve conversational turn-taking boundaries. Empirical latency: **`[TBP]`**.
