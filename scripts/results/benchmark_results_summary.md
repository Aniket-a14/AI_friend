...
> [!NOTE]
> CVS-3.5 uses Qwen3-1.7B running locally at 162.79ms mean inference. The baseline uses cloud-hosted large models. THREAT recall is exceptionally high (97.8%) — the system errs on the side of caution for safety.
...
**Confusion Matrix (CVS-3.5):** TP=632, FN=12, FP=58, TN=298

**Interruption Latency:**

| System | Mean Latency | Std Dev |
|---|---|---|
| **CVS-3.5** | **104.3 ms** | 7.72 ms |
| Baseline | 479.9 ms | 49.32 ms |
