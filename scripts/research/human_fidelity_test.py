...
SCENARIOS = [
    {
        "text": "I finally got the job I wanted! I'm so happy!",
        "expected_tag": "[laughs]",
        "trend": "Positive / High Arousal",
    },
    {
        "text": "I feel like I'm failing everyone. Everything is going wrong.",
        "expected_tag": "[sighs]",
        "trend": "Negative / High Arousal",
    },
    {
        "text": "The weather is okay today. Just a normal day.",
        "expected_tag": None,
        "trend": "Neutral / Low Arousal",
    },
    {
        "text": "You are my best friend, I trust you completely.",
        "expected_tag": None,
        "trend": "High Trust / Personal Wing",
    },
]
...
async def run_human_fidelity_test():
    ...
    for scenario in SCENARIOS:
        ...
        print(
            f"🧠 Wings Triggered: {list(set(captured_wings)) if captured_wings else 'No Recall'}"
        )
    ...
    print(
        "Use the 'collector.py' CSV data to plot the full affective arc for your paper."
    )
