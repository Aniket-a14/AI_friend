...
def compile_pdf_report(data):
    ...
    refs_col1 = [
        "[1] G. Skantze and B. Irfan, 'Applying VAP to Social Humanoid Robots in Dyadic Interactions,' in Proc. HRI, 2025.",
        "[2] G. Skantze, 'Turn-taking in conversational systems,' Found. Trends Inf. Retr., vol. 15, no. 1, pp. 1-101, 2021.",
        "[3] E. Nokland and G. Skantze, 'Voice Activity Projection with Transformer-Based Language Models,' in Proc. Interspeech, 2024.",
        "[4] E. Ekstedt and G. Skantze, 'VAP: A Multimodal Model for Turn-Taking,' IEEE Trans. ASLP, vol. 32, pp. 812-825, 2024.",
        "[5] K. Inoue, B. Lala, and T. Kawahara, 'Real-Time Turn-Taking for a Humanoid Robot,' in Proc. LREC-COLING, 2024.",
        "[6] L. Schulz, K. Miller, and S. Becker, 'Probabilistic Turn-Taking Using E2E Latency Control,' IEEE T-RO, vol. 41, pp. 102-115, 2025.",
        "[7] B. Lala, K. Inoue, and T. Kawahara, 'Attentive turn-taking using gaze and speech,' in Proc. HRI, 2019.",
        "[8] Y. Hu, X. Zhang, and M. Liu, 'How LLMs Simulate Theory of Mind: Sparse Neural Pattern Analysis,' Nature Mach. Intell., vol. 7, 2025.",
        "[9] S. Chen, H. Wang, and Y. Zhao, 'ToM Assessment in LLMs: Boundaries and Limits,' in Proc. ACL, 2025.",
        "[10] A. Mehrabian, 'Analysis of the PAD Emotion State Model,' Basic Appl. Soc. Psychol., vol. 18, no. 2, 1996.",
        "[11] K. R. Scherer, 'The Component Process Model of Emotion,' Soc. Sci. Inf., vol. 48, no. 3, pp. 347-381, 2009.",
        "[12] R. W. Picard, Affective Computing, MIT Press, 1997.",
        "[13] C. Busso et al., 'Multimodal Affective Computing in HRI: A Survey,' IEEE Trans. Affect. Comput., vol. 15, no. 2, 2024.",
        "[14] F. Ringeval et al., 'Introducing the RECOLA database,' in Proc. IEEE FG, 2013.",
        "[15] S. C. Marsella and J. Gratch, 'EMA: A process model of appraisal,' Cogn. Syst. Res., vol. 10, no. 1, 2009.",
    ]
    refs_col2 = [
        "[16] N. Kramer et al., 'WASABI: A continuous emotion model for virtual agents,' in ACII, 2013.",
        "[17] J. Wu, C. Lebiere, and J. R. Anderson, 'Integrating Cognitive Architectures with LLMs,' J. Neurosymbolic AI, vol. 1, 2024.",
        "[18] D. Edge et al., 'From Local to Global: A Graph RAG Approach,' Microsoft Research, 2024.",
        "[19] S. Xiao et al., 'BGE M3-Embedding: Multi-Lingual, Multi-Granularity,' arXiv:2402.03216, 2024.",
        "[20] G. Izacard et al., 'Unsupervised dense retrieval with contrastive learning,' TMLR, 2022.",
        "[21] B. Gutierrez et al., 'HippoRAG: Neurobiologically Inspired LTM Retrieval,' in Proc. NeurIPS, 2024.",
        "[22] N. Hale et al., 'BEIR: Zero-shot evaluation of IR models,' in Proc. NeurIPS, 2021.",
        "[23] P. Lewis et al., 'Retrieval-Augmented Generation for NLP,' in Proc. NeurIPS, 2020.",
        "[24] Y. Maruyama et al., 'Quantitative evaluation of ROS 2 performance,' in Proc. IROS, pp. 400-407, 2016.",
        "[25] NATS.io Project, 'NATS.io: High-performance pub-sub messaging,' CNCF Tech. Reports, 2024.",
        "[26] PyO3 Contributors, 'PyO3: Rust bindings for Python,' Rust Found. Tech. Library, 2024.",
        "[27] NVIDIA Corp., 'Jetson AGX Orin Technical Specifications,' NVIDIA Developer Guides, 2023.",
        "[28] Apple Hardware Eng., 'Apple M3 Chip Family Architectural Deep-Dive,' Apple Whitepapers, 2023.",
