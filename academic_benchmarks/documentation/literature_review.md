...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Speech Barge-in Stop** | Cloud VLM Delay (~300ms) | N/A (Secondary audio) | Cloud VAD (~400ms) | Tritium Stream Buffer (~250ms) | 200.0 ms | N/A | N/A | **NOT MEASURED end-to-end — flush mechanism exists (built 2026-08-23, resolver-gated since 2026-09-01), but no live stopwatch trial of the full path has been run; see measurement 1.1's pre-fix number** |
