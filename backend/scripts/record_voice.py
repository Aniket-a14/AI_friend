...
if __name__ == "__main__":
    try:
        ...
        name = input("Enter filename (default: voice_sample.wav): ") or "voice_sample.wav"
        record_audio(seconds, name)
    except KeyboardInterrupt:
        print("\n❌ Cancelled")
    except Exception as e:
        print(f"\n❌ Error: {e}")
        print("Tip: You might need to install sounddevice: pip install sounddevice soundfile numpy")
