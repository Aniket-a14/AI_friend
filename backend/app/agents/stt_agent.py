...
class STTAgent(BaseAgent):
    ...
    async def start(self):
        ...
        await self.subscribe("audio.inbound", self._on_audio_inbound, deliver_policy="new")
    ...
    async def _on_audio_inbound(self, data: dict):
        ...
        try:
            ...
            if self.stt_service.is_speaking and self.stt_service.silence_start_time is None:
