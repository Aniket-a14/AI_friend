...
class VoiceAgent(BaseAgent):
    ...
    async def start(self):
        ...
        await self.subscribe("chat.output", self._handle_text_input, durable=self.durable_name, deliver_policy="new")
        ...
        logger.info(f"🎙️ {self.name} started and listening to chat.output and audio.stop")
