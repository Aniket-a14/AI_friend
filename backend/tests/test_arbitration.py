...
@pytest.mark.parametrize("backbone_text, perception_keywords, expected_confirmed", [
...
def test_speculative_stop_arbitration(decision_service, backbone_text, perception_keywords, expected_confirmed):
    """
...
def test_conflict_resolver_case_insensitivity(decision_service):
    ...
    assert decision_service.is_speculative_stop_confirmed("wait for it", ["WAIT"]) is False # Conversational
