...
export const PRESSURE_SCENARIOS: ScenarioBenchmark[] = [
  ...
  },
  {
    ...
    description: "Visual appraisal loop receiving continuous identical camera frames with perceptual habituation active.",
    ramUsedGB: 14.36,
  ...
  },
  {
    ...
    activeComponents: ["Full Mesh", "All Modalities"],
    concurrencyLevel: 4,
    notes: "Peak concurrency stress test without container eviction or buffer degradation.",
    measuredProvenance: "backend/tools/measure/out/m17_pressure_scenarios.json §7",
  },
  {
    id: 8,
    name: "Subconscious REM Consolidation",
    description: "Background memory decay, episodic node extraction, and Neo4j belief graph updates while conversation is idle.",
    ramUsedGB: 14.88,
    deltaFromIdleGB: 0.34,
    activeComponents: ["subconscious_agent", "Neo4j", "Ollama (qwen2.5:3b)"],
    concurrencyLevel: 1,
    notes: "Consolidation executes without impacting foreground real-time responsiveness.",
    measuredProvenance: "backend/tools/measure/out/m17_pressure_scenarios.json §8",
  },
  {
    id: 9,
    name: "Simultaneous Consolidation + Multimodal Turn",
    description: "Worst-case resource contention: background REM consolidation executing precisely when an interactive multimodal turn arrives.",
    ramUsedGB: 15.18,
    deltaFromIdleGB: 0.64,
    activeComponents: ["subconscious_agent", "brain_agent", "stt-agent", "voice-agent", "Moondream VLM", "Neo4j"],
    concurrencyLevel: 5,
    notes: "Max measured memory delta (+0.64 GB). System remained responsive with no OOM kill.",
...
export const REAL_MICRO_BENCHMARKS: MicroBenchmark[] = [
  {
    ...
    title: "Composed Turn Time-To-First-Token (TTFT)",
    measuredValue: "119.35 ms",
    benchmarkUnit: "milliseconds (composed turn: 34.57ms deliberation + 84.78ms prefill)",
    conditions: "Composed turn deliberation + prompt prefill on dedicated RTX 2060 Super (isolated prompt eval: 39.95 ms)",
    provenance: "live",
  },
  {
  ...
  {
    measurementId: "M1.9-BARGEIN-REFLEX",
    title: "Sub-Millisecond Barge-In Reflex",
    measuredValue: "0.099 ms",
    benchmarkUnit: "milliseconds (<1.0 ms hard threshold)",
    conditions: "Audio interruption reflex dispatch latency over NATS bus upon voice activity detection",
    provenance: "live",
  },
  {
    measurementId: "M1.10-ROLLBACK",
    title: "Deterministic State Rollback",
    measuredValue: "14.28 µs",
    benchmarkUnit: "microseconds (<500 µs safety gate)",
    conditions: "Atomic rollback of speculative cognitive state mutations upon turn cancellation",
    provenance: "live",
  },
  {
    measurementId: "M1.11-BOUNDARY-INVARIANCE",
    title: "Identity & Safety Boundary Invariance",
    measuredValue: "100%",
    benchmarkUnit: "invariance rate (0 violations / 1,200 adversarial turns)",
    conditions: "Constitutional guard evaluation across 1,200 adversarial redteam probes",
    provenance: "empirical",
  },
  {
    measurementId: "M1.12-META-OVERHEAD",
    title: "Metacognitive Latency Overhead",
    measuredValue: "0.17 ms",
    benchmarkUnit: "milliseconds per turn",
    conditions: "Calibration and second-order reflection directive generation overhead",
    provenance: "live",
  },
  {
    measurementId: "M1.13-CANDIDATE-SELECTION",
    title: "Candidate Action Selection Latency",
    measuredValue: "0.36 ms",
    benchmarkUnit: "milliseconds (10 candidate evaluation)",
    conditions: "Constraint-first scoring and selection across 10 competing action intents",
    provenance: "live",
  },
  {
    measurementId: "M1.14-PLAN-VERIFICATION",
    title: "Deterministic Plan Verification",
    measuredValue: "0.29 ms",
    benchmarkUnit: "milliseconds (<2.0 ms execution budget)",
    conditions: "Formal DAG verification of multi-step deliberative plans prior to execution",
    provenance: "live",
  },
  {
...
export const HARDWARE_MATRIX = [
  {
    ...
    ttftMs: "119.35 ms composed (39.95 ms isolated prompt eval)",
